...
def main(args):
    ...
    for sub_dir in sub_dirs:
        ...
        get_radar_flow_from_milliego(data_loc, smp_path, opt_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--root_dir', type=str, default='/home/zyw/odobeyondvision/2019-10-24-17-51-58',
                        help='Path for the original dataset.')
    parser.add_argument('--save_dir', type=str, default='/home/zyw/odobeyondvision/PreprocessingResults', help='Path for saving preprocessing results.')
